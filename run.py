...
def run(*argv):
	...
	parser = argparse.ArgumentParser(description='A language model with GRU. Attention, beamsearch,\
	...
	parser.add_argument('--droprate', type=float, default=0,
		help='The probability to be zeroed in dropout. 0 indicates for don\'t use dropout')
	...
	parser.add_argument('--wvid', type=str, default="resources://Glove300d",
		help="Resources/path for pretrained wordvector. Default: resources://Glove300d")
